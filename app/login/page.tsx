  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email === 'demo@example.com' && password === 'password123') {
        // Store authentication token (in a real app, this would be a JWT)
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-[#6B7280] dark:text-gray-400">
            Or{' '}
            <Link href="/register" className="font-medium text-[#00A878] hover:text-[#008F63]">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember-me"
                  type="checkbox"
                  className="h-4 w-4 text-[#00A878] focus:ring-[#00A878] border-gray-300 rounded dark:border-gray-700 dark:bg-gray-700"
                  checked={rememberMe}
                  onChange={(e) => setRememberMe(e.target.checked)}
                />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-[#6B7280] dark:text-gray-300">
                  Remember me
                </label>
              </div>

              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-[#00A878] hover:text-[#008F63]">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-gray-800 text-[#6B7280] dark:text-gray-400">
                  Or continue with
                </span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <div>
                <button
                  type="button"
                  className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 dark:border-gray-700 rounded-md shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-[#2C3E50] dark:text-white hover:bg-gray-50 dark:hover:bg-gray-600"
                >
